...
namespace MaturskiProjekat
{
    public partial class Form1 : Form
    {
        ...
        int i = 0,brkrt=0, br = 0,CrvCr, A, B, C, D,karta;
        public int pozadina = 3;
        Random r = new Random();
        Random r1 = new Random();
        int br0 = 0, br1 = 0, br2 = 0, br3 = 0, br4 = 0, br5 = 0, br6 = 0, br7 = 0, br2x2 = 0;
        ...
        private void labelDobitak_Click(object sender, EventArgs e)
        {
        ...
        {            
            ...
            if (Convert.ToInt32(s1) < Convert.ToInt32(s)) buttonZavrti.Enabled = false;
            else buttonZavrti.Enabled = true;
            if (stanje < ulog)
            {
        ...
        private void pravilaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            forma3.StartPosition = FormStartPosition.CenterScreen;
            forma3.ShowDialog();              
        }
        ...
        private void promenaMasinaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Form4 forma4 = new Form4();
            forma4.StartPosition = FormStartPosition.CenterScreen;
            forma4.Show();
            this.Hide();
        }
        ...
        private void labelVreme_Click(object sender, EventArgs e)
        {
        ...
        private void opcijeToolStripMenuItem_MouseHover(object sender, EventArgs e)
        {
        ...
        private void novaIgraToolStripMenuItem_MouseLeave(object sender, EventArgs e)
        {
           
        }

        private void izlazToolStripMenuItem_MouseLeave(object sender, EventArgs e)
        {

        }

        private void Meni_MouseLeave(object sender, EventArgs e)
        {
        ...
        private void Form1_MouseEnter(object sender, EventArgs e)
        {
            ...
            opcijeToolStripMenuItem.HideDropDown();
        }
        ...
        private void opcijeToolStripMenuItem_MouseMove(object sender, MouseEventArgs e)
        {
        ...
        private void labelUlog_Click(object sender, EventArgs e)
        {

        }

        private void labelTekstUlog_Click(object sender, EventArgs e)
        {
        ...
        private void timerDobitak_Tick(object sender, EventArgs e)
        {
            ...
            if (br0 == 2 || br1 == 2 || br2 == 2 || br3 == 2 || br4 == 2 || br5 == 2 || br6 == 2 || br7 == 2)
            {
                if (br2x2 == 2)
                {                  
                     labelDobitak.Text = Convert.ToString(Convert.ToInt32(labelUlog.Text) * 2);
                    ZvukDobitak.URL = "Materijal\\SlotMasinaDobitak1.mp3";
                    ZvukDobitak.controls.play();
                }
                else { 
            ...
            if (br0 == 4 || br1 == 4 || br2 == 4 || br3 == 4 || br4 == 4 || br5 == 4 || br6 == 4 || br7 == 4)
            {
                if (br0 == 4)
                {                    
            ...
            br0 = br1 = br2 = br3 = br4 = br5 = br6 = br7 = br2x2=0;
        ...
        private void timerZavrti_Tick(object sender, EventArgs e)
        {
            ...
            int a = r.Next(0, 8), b = r.Next(0, 8), c = r.Next(0, 8), d = r.Next(0, 8);
            if (br == 90)
            {
                buttonZavrti.Enabled = false;
                br = 0;
            ...
            else
            {
                ...
                if (br < 89) {
                    if (i == 1)
                    {
                        pictureBoxSlot4Gore.Image = BelaPozadina;
                        pictureBoxSlot4.Image = pictureSimboli[d].Image;
                    }
                    if (i == 2)
                    {
                        pictureBoxSlot4.Image = BelaPozadina;
                        pictureBoxSlot4Dole.Image = pictureSimboli[d].Image;
                    }
                    if (i == 3)
                    {
                        pictureBoxSlot4Dole.Image = BelaPozadina;
                        pictureBoxSlot4Gore.Image = pictureSimboli[d].Image;
                    }
                }
                if (br == 88) {
                    pictureBoxSlot4Dole.Image = BelaPozadina;
